...
public enum ReaderError : String, Printable {
  ...
  public var description : String {
    ...
    case UnmatchedReaderMacroError:
      desc = "reader macro token present without corresponding form"
    case IllegalFormError:
      desc = "form of illegal type provided to reader macro (e.g. None)"
    case UnquoteSpliceMisuseError:
      desc = "~@ used improperly (outside the context of a collection)"
    }
...
public struct EvalError : Printable {
  ...
  public var description : String {
    ...
    switch self.error {
    case .ArityError:
      if let expected = metadata[.ExpectedArity], actual = metadata[.ActualArity] {
